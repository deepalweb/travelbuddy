...
interface AdminSidebarProps {
  activeView: 'dashboard'|'users'|'places'|'deals'|'events'|'subscriptions'|'contentModeration'|'apiAnalytics'|'apiCost'|'apiInsights';
  setActiveView: (view: 'dashboard'|'users'|'places'|'deals'|'events'|'subscriptions'|'contentModeration'|'apiAnalytics'|'apiCost'|'apiInsights') => void;
  isOpen: boolean;
  onClose: () => void;
}
