...
export const LoginPage: React.FC = () => {
  ...
  const { login, register, loginWithGoogle, loginDemo, user, isLoading: authLoading } = useAuth()
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <Button
            ...
            disabled={loading}
            className="w-full py-3 mb-3 bg-white hover:bg-gray-50 text-gray-900 border-2 border-gray-300 flex items-center justify-center gap-3"
          >
